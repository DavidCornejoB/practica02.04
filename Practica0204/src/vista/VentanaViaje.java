...
public class VentanaViaje extends JInternalFrame {
    ...
    public VentanaViaje(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) {
    ...
    public void iniciaComponentes() {
        ...
        this.encabezado[0] = "Compañia";
        this.encabezado[1] = "Destino";
